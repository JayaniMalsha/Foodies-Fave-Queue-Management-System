...
public class HelloController  {
    ...
    private static FoodQueue cashier1;
    private static FoodQueue cashier2;
    private static FoodQueue cashier3;
    ...
    ArrayList<Customer> waitingQueueFX=new ArrayList<>();

    public void setData(int burgers, FoodQueue cashier1, FoodQueue cashier2, FoodQueue cashier3, WaitingQueue waitingQueue) {
        ...
        waitingQueueFX.addAll(waitingQueue.getCustomers());
        setWaitingList();
        setdetails();
    }
    @FXML
    ...
    private void setWaitingList(){
        ...
        for(Customer customer :waitingQueueFX){
            if(customer !=null){
    ...
    private void search(String name) {
        try{
            ...
            for (Customer customer : customers) {
                ...
                if (fullName.equals(lowerCaseName) || firstName.equals(lowerCaseName) || secondName.equals(lowerCaseName)) {
                    String fname = customer.getFirstName();
                    String sname = customer.getSecondName();
                    int burgers = customer.getBurgersRequired();
                    cusDetails.setText("First name: " + fname + "\n" + "Second name: " + sname + "\n" + "Burgers: " + burgers + "\n" + "Price of burgers: " + burgers*650);
                    found = true;
                    break;
                }
            }
